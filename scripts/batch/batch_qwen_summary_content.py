...
Usage:
  ...
  python scripts/batch/batch_qwen_summary_content.py

  # Later: poll once; if completed, download output JSONL and write Summary files
  python scripts/batch/batch_qwen_summary_content.py --check-status
...
def run_submit_flow() -> None:
    ...
    print("When the job finishes on the server, run: python scripts/batch/batch_qwen_summary_content.py --check-status")

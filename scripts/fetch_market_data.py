...
Reuses logic from fetch_forum_all.py and fetch_news_eastmoney.py; injects one shared SECTORS list.
...
# Single source of truth for which stocks to process (injected into both submodules).

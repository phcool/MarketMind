...
# Must match scripts/build_quotes_7d_dataset.py TAIL (single-char output instruction).
...
def run_submit_flow() -> None:
    ...
    print("When the job finishes on the server, run: python scripts/batch_qwen_cot_quotes_dataset.py --check-status")
